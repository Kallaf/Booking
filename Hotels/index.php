...
echo '<button type="button" id="logoutBtn" class="btn" style = "margin-left: 92%;background:#bb2323;">logout</button>';
echo '<script type="text/javascript">document.getElementById("logoutBtn").onclick = function () {location.href = "index.php?logout='."'1'".'";};</script>';
